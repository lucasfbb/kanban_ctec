...
const Perfil = () => {
  ...
  return (
    <div className="p-3 max-w-screen-xl mx-auto overflow-hidden">
      <div className="flex flex-col lg:flex-row gap-8" style={{ maxHeight: "87vh", overflowY: "hidden", overflowX: "hidden"}}>
        {/* Bloco do Perfil */}
        <div className="flex-1 bg-white shadow rounded-lg p-6" style={{ overflowY: "auto", overflowX: "hidden"}}>
        ...
        {/* Bloco de Projetos */}
        <div className="flex-1 bg-white shadow rounded-lg p-6" style={{ overflowY: "auto", overflowX: "hidden" }}>
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Projetos que já participei</h2>

          <ul className="space-y-3">
            <li className="p-3 border rounded hover:bg-gray-50 transition">
              <h3 className="font-medium text-gray-800">Projeto Sistema de Notificações</h3>
              <p className="text-sm text-gray-500">Participação: Desenvolvedor Fullstack</p>
            </li>
            <li className="p-3 border rounded hover:bg-gray-50 transition">
              <h3 className="font-medium text-gray-800">Projeto Kanban CTEC</h3>
              <p className="text-sm text-gray-500">Participação: Admin e Colaborador</p>
            </li>
            <li className="p-3 border rounded hover:bg-gray-50 transition">
              <h3 className="font-medium text-gray-800">Painel Inteligente de Prazos</h3>
              <p className="text-sm text-gray-500">Participação: Analista de Requisitos</p>
            </li>
          </ul>
        </div>
      </div>
